...
CREATE TABLE USERS (
      ...
      GENDER   VARCHAR2(12 BYTE)       NOT NULL,
...
INSERT INTO USERS
    (ID, USER_NO, PW, NAME, GENDER, EMAIL, MOBILE, BIRTHYEAR, BIRTHDAY, POSTCODE, ROAD_ADDRESS, JIBUN_ADDRESS, DETAIL_ADDRESS, EXTRA_ADDRESS, AGREE_CODE, SNS_TYPE, JOIN_DATE, PW_MODIFY_DATE, INFO_MODIFY_DATE, SESSION_ID, SESSION_LIMIT_DATE, POINT)
VALUES
    ('admin', USERS_SEQ.NEXTVAL,' FFE1ABD1A 8215353C233D6E0 9613E95EEC4253832A761AF28FF37AC5A15 C', 'ADMIN', '선택안함', 'admin@gmail.com', '01011111111', '1958', '0101', '11111', 'ROAD1', 'JIBUN1', 'DETAIL1','EXTRA1', 0, NULL, TO_DATE('20221111', 'YYYYMMDD'), NULL, NULL, NULL, NULL, 100, 0);
INSERT INTO USERS
    (ID, USER_NO, PW, NAME, GENDER, EMAIL, MOBILE, BIRTHYEAR, BIRTHDAY, POSTCODE, ROAD_ADDRESS, JIBUN_ADDRESS, DETAIL_ADDRESS, EXTRA_ADDRESS, AGREE_CODE, SNS_TYPE, JOIN_DATE, PW_MODIFY_DATE, INFO_MODIFY_DATE, SESSION_ID, SESSION_LIMIT_DATE, POINT)
VALUES
    ('user01', USERS_SEQ.NEXTVAL,' FFE1ABD1A 8215353C233D6E0 9613E95EEC4253832A761AF28FF37AC5A15 C', '이정행', '남자', 'user1@gmail.com', '01011112222', '1978', '0407', '32453', 'ROAD234', 'JIBUN113', 'DETAIL123','EXTRA165', 0, NULL, TO_DATE('20221123', 'YYYYMMDD'), NULL, NULL, NULL, NULL, 3, 0);
INSERT INTO USERS
    (ID, USER_NO, PW, NAME, GENDER, EMAIL, MOBILE, BIRTHYEAR, BIRTHDAY, POSTCODE, ROAD_ADDRESS, JIBUN_ADDRESS, DETAIL_ADDRESS, EXTRA_ADDRESS, AGREE_CODE, SNS_TYPE, JOIN_DATE, PW_MODIFY_DATE, INFO_MODIFY_DATE, SESSION_ID, SESSION_LIMIT_DATE, POINT)
VALUES
    ('user02', USERS_SEQ.NEXTVAL,'EDEE29F882543B956620B26D EE0E7E950399B1C4222F5DE 5E06425B4C995E9', '신준호', '남자', 'user2@gmail.com', '01022222222', '1998', '0707', '46723', 'ROAD323', 'JIBUN134', 'DETAIL323','EXTRA857', 0, NULL, TO_DATE('20221124', 'YYYYMMDD'), NULL, NULL, NULL, NULL, 5, 0);
INSERT INTO USERS
    (ID, USER_NO, PW, NAME, GENDER, EMAIL, MOBILE, BIRTHYEAR, BIRTHDAY, POSTCODE, ROAD_ADDRESS, JIBUN_ADDRESS, DETAIL_ADDRESS, EXTRA_ADDRESS, AGREE_CODE, SNS_TYPE, JOIN_DATE, PW_MODIFY_DATE, INFO_MODIFY_DATE, SESSION_ID, SESSION_LIMIT_DATE, POINT)
VALUES
    ('user03', USERS_SEQ.NEXTVAL,'318AEE3FED8C9D 4 D35A7FC1FA776FB31303833AA2DE885354DDF3D44D8FB69', '김나영', '여자', 'user3@gmail.com', '01033333333', '1936', '0207', '23453', 'ROAD824', 'JIBUN238', 'DETAIL156','EXTRA255', 0, NULL, TO_DATE('20221124', 'YYYYMMDD'), NULL, NULL, NULL, NULL, 7, 0);
INSERT INTO USERS
    (ID, USER_NO, PW, NAME, GENDER, EMAIL, MOBILE, BIRTHYEAR, BIRTHDAY, POSTCODE, ROAD_ADDRESS, JIBUN_ADDRESS, DETAIL_ADDRESS, EXTRA_ADDRESS, AGREE_CODE, SNS_TYPE, JOIN_DATE, PW_MODIFY_DATE, INFO_MODIFY_DATE, SESSION_ID, SESSION_LIMIT_DATE, POINT)
VALUES
    ('user04', USERS_SEQ.NEXTVAL,'79F06F8FDE333461739F22 090A23CB2A79F6D714BEE10 D E4B4AF249294619', '박지원', '여자', 'user4@gmail.com', '01044444444', '1989', '1007', '34573', 'ROAD267', 'JIBUN568', 'DETAIL9456','EXTRA355', 0, NULL, TO_DATE('20221124', 'YYYYMMDD'), NULL, NULL, NULL, NULL, 2, 0);
COMMIT;